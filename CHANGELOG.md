...
* `babel-preset-untitled`, `eslint-config-untitled`, `eslint-plugin-untitled`, `untitled`, `untitled-cli`, `untitled-core`, `untitled-scripts`

  - Clean up ([@billyzkid](https://github.com/billyzkid))
